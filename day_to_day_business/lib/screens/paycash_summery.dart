...
class _PayCashSummeryState extends State<PayCashSummery> {
  ...
  Stream paySummery;
   ...
   getPayCash() async {
    ...
    var  qn = await firestore.collection('PayCash Credit').where('IN' , isEqualTo: invoiceNumber).snapshots();
     print(qn);
    return qn;
              ...
              return ListView.builder(
                ...
                itemBuilder: (context , index){
                  ...
                  return Card(
                    color: Colors.blue,
                                      child: ListTile(
                         leading: Text(snapshot.data.documents[index].data['Date'], 
                         style: TextStyle(
                           fontWeight:FontWeight.bold
                         ),
                         ),
                         title: Text(snapshot.data.documents[index].data['Pay Cash'].toString()),
                    ),
                  );
                }
                );
